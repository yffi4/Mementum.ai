  ...
  return (
    <div className="onboarding w-full flex justify-center">
      <div className="max-w-6xl w-full px-4 pb-16">
        ...
        {/* Call to Action */}
        <div className="text-center bg-gradient-to-br from-purple-900/20 to-cyan-900/20 rounded-2xl p-12 border border-purple-500/20 max-w-4xl mx-auto">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">
            Ready to start your knowledge journey?
          </h2>
          <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
            Create your first note and see how AI transforms your thoughts into
