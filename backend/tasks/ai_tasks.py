...
def categorize_note_async(content: str) -> str:
    ...
    categories = {
        'Работа': ['работа', 'проект', 'задача', 'встреча', 'дедлайн', 'коллега'],
        'Обучение': ['учеба', 'курс', 'книга', 'изучить', 'обучение', 'урок'],
        'Личное': ['личное', 'семья', 'друзья', 'дом', 'хобби', 'отдых'],
        'Финансы': ['деньги', 'бюджет', 'расход', 'доход', 'инвестиции', 'счет'],
        'Здоровье': ['здоровье', 'врач', 'лекарство', 'спорт', 'диета', 'сон'],
        'Идея': ['идея', 'мысль', 'концепция', 'план', 'стартап', 'бизнес'],
        'Путешествия': ['путешествие', 'поездка', 'отпуск', 'билет', 'отель'],
        'Покупки': ['купить', 'покупка', 'магазин', 'заказ', 'товар'],
    }
