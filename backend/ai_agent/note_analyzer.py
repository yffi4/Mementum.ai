...
class NoteAnalyzer:
    ...
    CATEGORIES = {
        "ru": {
            "Learning": ["курс", "лекция", "изучение", "обучение", "образование", "tutorial", "гайд", "инструкция"],
            "Project": ["проект", "задача", "план", "этап", "milestone", "цель", "техзадание", "requirements"],
            "Idea": ["идея", "концепция", "мысль", "инновация", "предложение", "brainstorm", "креатив"],
            "Work": ["работа", "офис", "коллега", "начальник", "задание", "отчет", "встреча", "совещание"],
            "Research": ["исследование", "анализ", "изучение", "эксперимент", "данные", "статистика", "research"],
            "Finance": ["деньги", "бюджет", "расходы", "доходы", "инвестиции", "банк", "кредит", "налоги"],
            "Health": ["здоровье", "врач", "лечение", "диета", "спорт", "фитнес", "медицина", "болезнь"],
            "Travel": ["путешествие", "поездка", "отпуск", "отель", "билет", "виза", "маршрут"],
            "Shopping": ["покупка", "магазин", "товар", "цена", "скидка", "заказ", "доставка"],
            "Personal": ["семья", "друзья", "хобби", "личное", "дом", "отношения", "эмоции"],
            "Tech": ["программирование", "код", "алгоритм", "технология", "IT", "software", "hardware"],
            "Links": ["ссылка", "статья", "документ", "ресурс", "материал", "источник"],
            "General": ["заметка", "запись", "информация", "разное", "прочее"]
        },
        "en": {
    ...
    async def categorize_note(self, content: str) -> str:
        ...
        try:
            ...
            # Проверяем корректность категории - всегда используем английские категории
    ...
    def _categorize_by_keywords(self, content: str, language: str) -> str:
        ...
        # Всегда используем английские категории, но ключевые слова из соответствующего языка
